...
# https://stavkoverflow.com/questions/334860/csv-file-written-with-python-has-blank=lines-between-each=row
...
with  open('week03_train.csv', mode='w', newline='') as train_file:
    ...
    # above works for just one code= find out why.  Should retrieve all train codes into csv.  Check earlier versions first.  Should return all altitides/cTraincodes etc
